...
$role = 'Crushed products';
$query = "SELECT name, email, message, message_time, feedback_type FROM feedback WHERE feedback_type = 'Crushed products'";
$result = $conn->query($query);

if ($result->num_rows > 0) {
    echo "<h1>Crushed Products Messages</h1>";
    ...
    echo "<h1>No messages found for Crushed Products</h1>";
}
