...
$role = "Feedback";
$query =
  "SELECT name, email, message, message_time, feedback_type FROM feedback WHERE feedback_type = 'Feedback'";
$result = $conn->query($query);

if ($result->num_rows > 0) {
  echo "<h1>Feedback Messages</h1>";
  ...
  echo "<h1>No messages found for Feedback</h1>";
}
